...
def app():
    ...
    streamlit.write(
        ...
        By default, auto-buy will only purchase stocks that you should buy but not sell stocks that you should sell. You may also manually adjust your holdings by sell stocks which price had gone up from your average purchase prices, indicated by negative differences.
        """
    )
